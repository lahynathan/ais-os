...
**Convention de chiffre, et elle vaut surtout pour les formulations à ne pas dépasser.** Ce document ne produit aucun décompte : il reprend ceux des livrables, et **chaque chiffre repris porte la date de son recomptage et le document qui fait foi**, sur le modèle de 04 §4. La raison est opératoire : ces réponses se disent à voix haute en séance, et un dirigeant qui cite un chiffre plus ancien que celui du plan versé offre une contradiction gratuite sur le seul terrain où le dossier est solide. Les deux chiffres cités ici sont, au 18 septembre 2026 : la charge du plan, **215 j·p soit 43 semaines** (07 §5.1) ; le questionnaire de sécurité, **81 lignes « inconnue » sur 100** (04 §4). Avant toute séance, ces deux valeurs se revérifient dans leur document de référence, pas dans celui-ci. *Cette convention et les cinq passages qu'elle accompagne — Q69, Q70 (deux passages, dont la formulation à ne pas dépasser), Q17 et Q36 — sont apportés par le second passage du contre-audit (objection N-5) ; aucun statut de constat n'est relevé à cette occasion.*
...
- **Ce qui manque pour répondre pleinement.** Un plan de trésorerie tenu, mois par mois, intégrant explicitement l'hypothèse de renfort du plan de remédiation (Q70) : le plan P0 plus P1 pèse **215 jours-personne, soit 43 semaines** pour une seule personne — décompte au 18/09/2026, livrable 07 §5.1, qui fait foi —, et cette charge doit apparaître en trésorerie avant d'apparaître en calendrier.
...
- **Réponse factuelle aujourd'hui.** Le plan existe et il est chiffré **en jours-personne seulement** : **54 j·p en P0, 161 j·p en P1, soit 215 j·p au total** — décompte au 18/09/2026, livrable 07 §5.1, qui fait foi ; la version antérieure de cette réponse portait 196 j·p, chiffre du périmètre d'origine, périmé depuis le reclassement du rejeu de la phase 1 et l'ouverture des lignes du contre-audit. Traduit pour l'équipe réelle — une personne qui est simultanément CEO en levée, CTO, support et commercial — cela fait **43 semaines**, alors que P1 est annoncé « avant le closing ». Aucune levée ne dure dix mois de remédiation. **Aucun coût en euros sourcé par un devis n'a été posé** : le chiffrage du §5.4 de 07 est explicitement une hypothèse — 78 000 € HT de renfort, enveloppe de 130 000 à 160 000 € HT —, aucun devis de test d'intrusion n'a été demandé et aucune provision d'honoraires n'est contractée pour les trois mandats externes. Le chemin critique, lui, existe depuis le second chiffrage (07 §5.3, plancher de 12 semaines qu'aucun renfort ne compresse), et la marge d'aléa ne porte que sur l'enveloppe financière, pas sur les jours.
...
- **Formulation à ne pas dépasser.** « P0 plus P1 représente 215 jours-personne. Tenus par une personne seule, c'est 43 semaines à plein temps, et 86 semaines au rythme réel d'un fondateur en levée. Le calendrier que nous vous présentons suppose un renfort de [X] personnes à partir de [date], pour [Y] euros ; le chemin critique fixe par ailleurs un plancher de 12 semaines qu'aucun renfort ne compresse, et cette ligne fait partie de l'usage des fonds. » *(Chiffres et formulation alignés sur 07 §5.1 et §5.4, décompte au 18/09/2026.)* **Cette phrase transforme un plan intenable en argument de levée** ; son absence transforme le même plan en preuve d'optimisme.
...
- **Réponse factuelle aujourd'hui.** Non déterminé à ce jour. Le questionnaire de sécurité prérempli compte **100 lignes, dont 81 « inconnue »** — décompte au 18/09/2026, livrable 04 §4, qui fait foi ; la version antérieure de cette réponse portait « 85 sur 97 », décompte d'avant le screening MCP. La continuité d'activité en fait partie intégralement. Aucune page de statut public n'a été trouvée, aucun engagement de disponibilité non plus.
...
- **Réponse factuelle aujourd'hui.** Non déterminé à ce jour, aucun rapport public. C'est la pièce qui manque le plus au dossier sécurité : sans elle, le questionnaire de sécurité prérempli reste majoritairement sans réponse — **81 lignes « inconnue » sur 100** (décompte au 18/09/2026, livrable 04 §4, qui fait foi).
