...
Sous-total : **17,5 j·p** (13,5 à l'origine, plus 1 j·p sur P0-09 élargi aux trois qualifications et 3 j·p de lignes nouvelles).
...
| P0-21 | **Rejeu de la phase 1 avec l'egress ouvert.** Reprendre la collecte que la politique réseau a empêchée : ouvrir les pages du produit, du site et de la documentation, relever les en-têtes de sécurité et la configuration TLS, les enregistrements DNS, le parc de sous-domaines par les journaux de certificats, les sites clients, les pages tarifaires, les pages concurrentes, les scores de performance. Remonter au statut **CONFIRMÉ ou CONTREDIT** les constats aujourd'hui plafonnés à PROBABLE. **Reclassé de P1-23 en P0** — justification ci-dessous. | 10 j·p | CTO | R-31, R-08, R-27, R-34, R-37, R-38 |
...
**Total P0 : 53,5 j·p**, soit environ **54 jours-personne**, plus deux mandats externes — le mandat unique sur les trois qualifications fiscale, comptable et consommation, et le mandat conformité et propriété intellectuelle. Pour une seule personne à plein temps, **onze semaines**. Le périmètre d'origine était de 40 j·p, soit huit semaines ; l'écart vient du reclassement de P0-21 (10 j·p), de l'élargissement de P0-09 (1 j·p) et des trois lignes ouvertes par le contre-audit (3 j·p).
...
|---|---|---|---|
| **P0** | Avant l'ouverture de la data room | **53,5 j·p** | mandat unique sur les trois qualifications (fiscale, comptable, consommation), mandat conformité et propriété intellectuelle |
| **P1** | Avant le closing | **161 j·p** | test d'intrusion, avocats, expert-comptable |
| **P2** | Après le closing | **135 j·p** | test d'intrusion annuel |
| **Total** | | **environ 350 j·p** | |
...
**P0 + P1 = 53,5 + 161 = 214,5 j·p, arrondi à 215 j·p.** À 5 jours ouvrés par semaine et à 100 % de disponibilité, pour **une seule personne** : **43 semaines**, soit près de **dix mois**. Aucune levée ne dure dix mois de remédiation.

Le calcul au périmètre d'origine, avant le reclassement du rejeu de la phase 1 et les cinq lignes ouvertes par le contre-audit, était déjà de **40 + 156 = 196 j·p, soit 39 semaines**. Le reclassement ne crée pas le problème : il le rend visible.
...
| Scénario | Capacité | P0 (53,5 j·p) | P1 (161 j·p) | P0 + P1 |
|---|---|---|---|---|
| Fondateur seul, 100 % du temps | 1,0 ETP | 11 semaines | 32 semaines | **43 semaines** |
| Fondateur seul, 50 % du temps | 0,5 ETP | 21 semaines | 64 semaines | **86 semaines** |
...
4. **Aucune marge d'aléa dans les lignes elles-mêmes.** Les 350 j·p sont une somme d'estimations nominales, chacune faite sans reprise, sans revue, sans incident et sans interruption. Les 20 % du §5.4 portent sur l'enveloppe financière, pas sur les jours.
